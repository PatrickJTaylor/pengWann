...
class AtomicInteraction:
    ...
    def tag(self) -> str:
        ...
        The tags generated by this property have the general form "Xi<=>Yj", where X and
        Y are elemental symbols whilst i and j are indices.
